...
var inspectionModel_1 = __importDefault(require("../models/inspectionModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allInspections, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, inspectionModel_1.default.find(req.body).sort({ account_name: 1 }).exec()];
            case 1:
                allInspections = _a.sent();
                if (allInspections) {
...
exports.add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var inspection, newInspection, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    inspection = new inspectionModel_1.default();
                    ...
                    return [4 /*yield*/, inspection.save()];
                case 1:
                    newInspection = _a.sent();
                    if (newInspection) {
                        res.status(201).json({
                            status: "success",
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedInspection, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, inspectionModel_1.default.findByIdAndUpdate(req.body._id, data)];
                case 1:
                    updatedInspection = _a.sent();

...
var add = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, group_id, account_name, owner_id, owner_name, contacts, is_active, stage, geo_location, address_street, address_city, address_state, address_zip, email, demo, conversion, hauling_contract, hauling_expiration, national, referral, referral_group_id, notes, account, newAccount, err_2;
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedAccount, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, accountModel_1.default.findByIdAndUpdate(req.body._id, data)];
                case 1:

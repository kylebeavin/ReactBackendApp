...
router.route('/contacts')
    ...
    .post(verifyToken_1.verifyToken, validators_1.contactValidatorPost(), contactController_1.add)
    .put(verifyToken_1.verifyToken, validators_1.contactValidatorUpdate(), contactController_1.update)
    .patch(verifyToken_1.verifyToken, validators_1.contactValidatorUpdate(), contactController_1.update)

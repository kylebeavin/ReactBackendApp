...
router.route('/orders')
    ...
    .post(verifyToken_1.verifyToken, validators_1.orderValidatorPost(), orderController_1.add)
    .put(verifyToken_1.verifyToken, validators_1.orderValidatorUpdate(), orderController_1.update)
    .patch(verifyToken_1.verifyToken, validators_1.orderValidatorUpdate(), orderController_1.update)

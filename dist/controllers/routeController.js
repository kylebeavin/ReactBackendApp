...
var routeModel_1 = __importDefault(require("../models/routeModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, routeModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allRoutes = _a.sent();
                if (allRoutes) {
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedRoute, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, routeModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:

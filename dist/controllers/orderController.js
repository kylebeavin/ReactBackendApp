...
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allOrders = _a.sent();
                if (allOrders) {
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var errors, order, newOrder, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedOrder, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, orderModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:

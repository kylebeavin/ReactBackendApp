...
var meetingModel_1 = __importDefault(require("../models/meetingModel"));
var express_validator_1 = require("express-validator");
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allMeetings, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, meetingModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allMeetings = _a.sent();
                if (allMeetings) {
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var errors, meeting, newMeeting, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ...
                    meeting = new meetingModel_1.default();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, meetingModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false, runValidators: true })];
                case 1:

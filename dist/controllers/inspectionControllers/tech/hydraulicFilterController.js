...
var hydraulicFilterModel_1 = __importDefault(require("../../../models/inspectionModels/tech/hydraulicFilterModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allHydraulicFilters, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, hydraulicFilterModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allHydraulicFilters = _a.sent();
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var hydraulicFilter, newHydraulicFilter, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    hydraulicFilter = new hydraulicFilterModel_1.default();
                    ...
                    return [4 /*yield*/, hydraulicFilter.save()];
                case 1:
                    newHydraulicFilter = _a.sent();
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedHydraulicFilter, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, hydraulicFilterModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:
                    updatedHydraulicFilter = _a.sent();

...
var weeklyTechModel_1 = __importDefault(require("../../../models/inspectionModels/tech/weeklyTechModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, weeklyTechModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allWeeklys = _a.sent();
                if (allWeeklys) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    weekly = new weeklyTechModel_1.default();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, weeklyTechModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:

...
var emergencyServiceModel_1 = __importDefault(require("../../../models/inspectionModels/info/emergencyServiceModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allEmergencyServices, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, emergencyServiceModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allEmergencyServices = _a.sent();
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var emergencyService, newEmergencyService, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    emergencyService = new emergencyServiceModel_1.default();
                    ...
                    return [4 /*yield*/, emergencyService.save()];
                case 1:
                    newEmergencyService = _a.sent();
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedEmergencyService, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, emergencyServiceModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:
                    updatedEmergencyService = _a.sent();

...
var kenworthDealerModel_1 = __importDefault(require("../../../models/inspectionModels/info/kenworthDealerModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allKenworthDealers, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, kenworthDealerModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allKenworthDealers = _a.sent();
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var kenworthDealer, newKenworthDealer, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    kenworthDealer = new kenworthDealerModel_1.default();
                    ...
                    return [4 /*yield*/, kenworthDealer.save()];
                case 1:
                    newKenworthDealer = _a.sent();
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedKenworthDealer, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, kenworthDealerModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:
                    updatedKenworthDealer = _a.sent();

...
var bigRigServiceModel_1 = __importDefault(require("../../../models/inspectionModels/info/bigRigServiceModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allBigRigServices, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, bigRigServiceModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allBigRigServices = _a.sent();
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var bigRigService, newBigRigService, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    bigRigService = new bigRigServiceModel_1.default();
                    ...
                    return [4 /*yield*/, bigRigService.save()];
                case 1:
                    newBigRigService = _a.sent();
                    if (newBigRigService) {
                        res.status(201).json({
                            status: "success",
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedBigRigService, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, bigRigServiceModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:
                    updatedBigRigService = _a.sent();

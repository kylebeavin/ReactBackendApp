...
var tireVendorModel_1 = __importDefault(require("../../../models/inspectionModels/info/tireVendorModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allTireVendors, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, tireVendorModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allTireVendors = _a.sent();
                if (allTireVendors) {
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var tireVendor, newTireVendor, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    tireVendor = new tireVendorModel_1.default();
                    ...
                    return [4 /*yield*/, tireVendor.save()];
                case 1:
                    newTireVendor = _a.sent();
                    if (newTireVendor) {
                        res.status(201).json({
                            status: "success",
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedTireVendor, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, tireVendorModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:
                    updatedTireVendor = _a.sent();

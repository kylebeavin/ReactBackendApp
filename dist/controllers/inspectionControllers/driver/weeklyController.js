...
var weeklyDriverModel_1 = __importDefault(require("../../../models/inspectionModels/driver/weeklyDriverModel"));
//for queries
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allWeeklys, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, weeklyDriverModel_1.default.find(req.body).sort({ created_at: 1 }).exec()];
            case 1:
                allWeeklys = _a.sent();
                if (allWeeklys) {
...
var add = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var weekly, newWeekly, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    weekly = new weeklyDriverModel_1.default();
...
var update = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var data, updatedWeekly, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    data = __assign({}, req.body);
                    return [4 /*yield*/, weeklyDriverModel_1.default.findByIdAndUpdate(req.body._id, data, { new: true, useFindAndModify: false })];
                case 1:
                    updatedWeekly = _a.sent();

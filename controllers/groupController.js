...
exports.add = function (req, res) {
    ...
    group.addressStreet = req.body.addressStreet;
    group.addressCity = req.body.addressCity;
    group.addressState = req.body.addressState;
    group.addressZip = req.body.addressZip;
